...
/**
 * Curated mock venue facts for the FanPulse hackathon demonstration.
 * These values are intentionally reviewable source data, not a live or official feed.
 */
export const stadiumKnowledgeBase: StadiumKnowledgeBase = {
  ...
  provenance: {
    ...
    official: false,
    notice:
      "Prototype mock venue data for demonstration only; not official FIFA or venue guidance.",
  },
  gates: [
    {
      id: "gate-a1",
      ...
      accessibility:
        "Level access, elevator to Club Level, wheelchair seating assistance desk on concourse",
    ...
    },
    {
      ...
      accessibility:
        "Ramp access from east parking; accessible restrooms 50m inside on left",
      notes:
        "High foot traffic during halftime — stage volunteers on the east concourse and follow control-room routing",
    },
    {
      id: "gate-c",
      name: "Gate C",
      ...
      accessibility:
        "Wheelchair route via west plaza ramp; hearing loop at guest services",
    ...
    },
    {
      ...
      accessibility:
        "Step-free access; may be activated when Gate C exceeds 80% queue capacity",
      notes:
        "Overflow gate — opening requires control-room authorization and on-site confirmation",
    },
  ],
  sections: [
    {
  ...
  transport: [
    ...
    },
    {
      ...
      notes:
        "General admission; arrive 90+ min early. EV charging stations in rows 12–14",
    },
    {
      id: "parking-p2",
      name: "Parking Lot P2",
      ...
      notes:
        "Accessible parking rows A–D nearest to gate; pre-book recommended",
    },
    {
  ...
  sustainability: [
    ...
    },
    {
      ...
      notes:
        "Metro + shuttle combo cuts match-day carbon ~40% vs solo driving. Bike valet at Lot P2 east entrance.",
    },
  ],
  faqs: [
    {
